...
const EarnPointNewUser = () => {
  return (
    <div className="w-80 h-24 bg-blue-200 p-6 rounded gap-4 absolute top-6 left-6 flex items-center justify-between">
      ...
      <div>
          <label htmlFor="email" className="font-inter text-sm font-semibold text-gray-600">Enter Email Address</label>
          <input type="email" id="email" className="w-full h-10 border-gray-300 border rounded px-3" placeholder="Enter email" />
        </div>
        <div>

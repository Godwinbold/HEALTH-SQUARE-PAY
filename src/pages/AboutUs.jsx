			...
			<div className="bg-gray-50">
				...
				<div className="block xl:flex lg:flex md:flex lg:mb-32 xl:mb-32 md:mb-16 mb-8 bg-gray-50">
					<div className="xl:w-1/2 lg:w-1/2 md:w-1/2 w-full xl:pl-24 lg:pl-24  md:pl-24  p-8 pr-8 ">
						<div className="text-5xl md:text-4xl font-semibold mb-8 text-align-center xl:text-align-right lg:text-align-right md:text-align-right">Healthsquare Pay</div>
						<div className="block text-xl md:text-lg text-gray-700 text-align-center xl:text-align-right lg:text-align-right md:text-align-right">
					...
					<div className="xl:w-1/2 lg:w-1/2 md:w-1/2 w-full xl:pl-24 lg:pl-24  md:pl-24  p-8 pr-8 ">
						<div className="text-5xl md:text-4xl font-semibold mb-8 text-align-center xl:text-align-right lg:text-align-right md:text-align-right">Our Vision</div>
						<div className="block justify-evenly text-xl md:text-lg text-gray-700 text-align-center xl:text-align-right lg:text-align-right md:text-align-right">
				...
				<div className="block xl:flex lg:flex md:flex bg-white pt-4 xl:pt-16 lg:pt-16 md:pt-16 xl:mb-64 lg:mb-64 md:mb-16 mb-8">
					...
					<div className="xl:w-1/2 lg:w-1/2 md:w-1/2 w-full xl:pr-24 lg:pr-24 md:pr-24 p-8 xl:pl-8 lg:pl-8 md:pl-8">
						<p className="xl:text-3xl lg:text-3xl md:text-md text-sm text-gray-700 font-bold mb-8 sm:mb-2 text-align-center xl:text-align-right lg:text-align-right md:text-align-right">At Healthsquare Pay, we are committed to fostering a healthier Africa by empowering individuals to take control of their healthcare journey. Whether you're seeking routine check-ups, specialized treatments, or emergency care, Healthsquare Pay is here to support you every step of the way.</p>
						<p className="xl:text-xl lg:text-xl md:text-sm text-xs mb-10 sm:mb-3 text-align-center xl:text-align-right lg:text-align-right md:text-align-right">Join us as we pave the way towards a healthier, happier Africa. Together, let's make quality healthcare accessible to all.</p>
